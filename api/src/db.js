...
const { User, Establishment, Site, Court, Booking, Favorites } = sequelize.models;
...
User.belongsToMany(Court, { through: "Favorites" });
Court.belongsToMany(User, { through: "Favorites" });
