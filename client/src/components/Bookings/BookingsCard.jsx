    ...
    <div className="flex flex-wrap -m-3">
      <div className="w-full flex flex-col p-3 max-w-3xl">
        <div className="dark:text-darkPrimary bg-white dark:bg-slate-600 rounded-lg shadow-lg overflow-hidden flex flex-1 flex-col sm:grid sm:grid-cols-2">
          ...
          <div className="flex flex-1 flex-col py-1 relative text-center">
            <h1 className="font-bold text-2xl dark:text-darkAccent">
              {establishment}
            </h1>

            <div className="pt-1 text-sm flex-1">
              <h1 className="py-1 dark:text-darkAccent text-base md:text-sm">🥅 {name}</h1>

              <h1 className="py-1 dark:text-darkAccent text-base md:text-sm">
                Código de reserva: "
              ...
              <h1 className="py-1">
                ...
                <span className="dark:text-darkAccent text-base md:text-sm"> {place}</span>
              </h1>
              ...
              <h1 className="py-1">
                <FontAwesomeIcon
                  ...
                  className="mr-2"
                />
                <span className="dark:text-darkAccent text-base md:text-sm">{format(fecha, "dd-MM-yyyy")} {timeZone}</span>
              </h1>
            </div>
