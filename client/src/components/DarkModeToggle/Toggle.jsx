...
function Toggle() {
  ...
  return (
    <div className="w-28 h-12 rounded-[200px] border-2 overflow-hidden relative bg-[url('https://leerzaam.com/wp-content/uploads/2021/03/10526.jpg')] bg-cover shadow-sm shadow-white">
      ...
      ></label>
      <span className="absolute w-28 h-12 z-[9] bg-[url('https://cdn.shopify.com/s/files/1/2537/9622/products/011-sunny_1024x1024.jpg?v=1511127320')] bg-[center] opacity-100 peer-checked:opacity-0 transition-all">
        {" "}
        <FontAwesomeIcon
          icon={faSun}
          size={"2x"}
